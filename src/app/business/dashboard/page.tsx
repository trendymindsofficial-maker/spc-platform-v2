  ...
  const approveRedemption =
    async (
      ...
      try {
        ...
        let newStudentPoints: number | null = null;
        ...
        await runTransaction(
          ...
          async (
             ...
             */
            // Business accounts are intentionally not allowed to read
            // private student points documents. Use Firestore increment()
            // so approval can safely add points without reading the total.
            newStudentPoints = null;
