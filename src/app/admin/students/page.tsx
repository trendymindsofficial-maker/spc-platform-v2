  ...
  return (
    <AdminProtected>
      <main className="min-h-screen bg-[#f6f8fc] text-slate-900">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className={`text-xs font-bold uppercase tracking-wider ${
                      pendingCount > 0 ? "text-orange-600" : "text-emerald-600"
                    }`}>
                      Pending Approval
                    </p>
                    <p className={`mt-2 text-3xl font-extrabold ${
                      pendingCount > 0 ? "text-orange-700" : "text-emerald-700"
                    }`}>
                      {pendingCount}
                    </p>
                  </div>
                  <div className={`flex h-12 w-12 items-center justify-center rounded-2xl text-xl ${
                    pendingCount > 0 ? "bg-orange-100" : "bg-emerald-100"
                  }`}>
                    {pendingCount > 0 ? "⏳" : "✓"}
                  </div>
                </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:col-span-2 lg:col-span-1">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-3xl font-extrabold text-slate-900">
                      {students.filter((student) => !isPending(student)).length}
                    </p>
                  </div>
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Search by student name. Pending accounts appear first.
                </p>
              </div>
              ...
              <div className="relative w-full md:max-w-md">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 pl-11 pr-4 text-sm font-medium text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                />
              </div>
            </div>
          </div>
                    ...
                    <div className="p-5 sm:p-6">
                      <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                        ...
                        <div className="flex min-w-0 items-start gap-4">
                          <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl text-lg font-extrabold ${
                            pending
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <h3 className="mt-1 text-xl font-extrabold">
                                {student.fullName || "Student"} — Complete Details
                              </h3>
                            </div>
                          </div>
                        ...
                        <div className="mb-5 rounded-3xl border border-[#d4af37]/25 bg-gradient-to-br from-[#fffaf0] to-[#f6e8b5] p-5">
                          ...
                          <div className="grid gap-3 sm:grid-cols-2">
                            {[
                              ...
                              ["🪪", "SBC Card Number", student.cardNumber],
                        ...
                        <div className="grid gap-5 lg:grid-cols-2">
                          <div className="rounded-3xl border border-[#d4af37]/40 bg-gradient-to-br from-[#07111f] via-[#1b2b43] to-[#a17a12] p-5 text-white shadow-md">
                            ...
                            <div className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#d4af37]/20 px-3 py-1.5 text-xs font-extrabold text-[#fff4bf] ring-1 ring-[#d4af37]/30">
                              {pending ? "⏳ Pending Approval" : "✓ Active SBC Member"}
                            </div>
                          </div>
                              ...
                              <div>
                                ...
                                <p className="mt-1 text-sm font-extrabold text-slate-800">
                                  {student.createdAt?.toDate
                                    ? student.createdAt.toDate().toLocaleString("en-IN")
        ...
        {/* VIEW / EDIT MODAL */}
        {selectedStudent && studentModalMode && (
          <div
                ...
                {studentModalMode === "view" ? (
                  <div className="grid gap-3 sm:grid-cols-2">
                    {[
                      ...
                      ["SBC Card Number", selectedStudent.cardNumber],
                  ...
                  <div className="space-y-5">
                    <div className="grid gap-4 sm:grid-cols-2">
                      {[
                        ["Full Name", editFullName, setEditFullName],
                        ["Email", editEmail, setEditEmail],
                        ["Mobile", editMobile, setEditMobile],
                        ["College", editCollege, setEditCollege],
                        ["Course", editCourse, setEditCourse],
                        ["Year", editYear, setEditYear],
                        ...
                        <div key={label as string}>
                          ...
                          <input
                            ...
                            inputMode={label === "Mobile" ? "tel" : undefined}
